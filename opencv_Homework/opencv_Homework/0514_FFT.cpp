...
//void Ideal_Highpass_Filtering(Mat &imgDFT, double D0);
...
//void Practice_FFT_Filtering(Mat src, double DO, int isHigh)
//{
//	// 출력물 참조
...
//
//	if (isHigh >= 1) 
//		Ideal_Highpass_Filtering(freq, DO);
//	else 
//		Ideal_Lowpass_Filtering(freq, DO);
//
//	//imshow("중간결과", freq);
//	//waitKey();
//
...
//
//// [실습2] 위상상관을 이용한 매칭
//void Pratice_Phase_Correlation_Image(Mat src_img, Mat tpl_img)
//{
//	//Mat src_img = imread("", IMREAD_GRAYSCALE);
//	//Mat tpl_img = imread("", IMREAD_GRAYSCALE);
//
